...
public sealed class DiagnosticIndexedDbProbe : IDiagnosticIndexedDbProbe
{
    ...
    public DiagnosticIndexedDbProbe(IJSRuntime jsRuntime, DiagnosticsClientConfig config)
    {
        _jsRuntime = jsRuntime;
        _config = config;
    }

    public async Task<DiagnosticProbeResultModel> RunIsolatedAsync(CancellationToken cancellationToken)
    {
        var result = new DiagnosticProbeResultModel { DatabaseName = IsolatedDatabaseName };
