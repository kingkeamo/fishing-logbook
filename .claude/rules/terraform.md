...
- Add resources **deliberately, one at a time, only when explicitly approved.** The
  current modules are skeletons that declare naming locals but no resources yet.
