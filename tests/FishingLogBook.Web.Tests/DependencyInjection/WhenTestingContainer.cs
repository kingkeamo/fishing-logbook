...
public class WhenTestingContainer : BaseDependencyInjectionTest
{
    ...
    public async Task ItShouldResolveServicesInjectedByComponents()
    {
        ...
        injectedTypes.Should().Contain(typeof(ILogbookSynchroniser));
        injectedTypes.Should().Contain(typeof(IActiveTripService));
        injectedTypes.Should().Contain(typeof(ITripStore));
