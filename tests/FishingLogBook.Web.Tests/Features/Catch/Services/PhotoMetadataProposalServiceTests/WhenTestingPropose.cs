...
public class WhenTestingPropose : BasePhotoMetadataProposalServiceTest
{
    [Fact]
    public void ItShouldProposeNothingWhenNoPhotographsAreSelected()
    {
        ...
        // Assert
        proposal.Should().Be(PhotoMetadataProposalModel.Empty);
    }
    ...
    {
        // Arrange
        var photographs = new[] { PhotoMetadataModel.Empty, PhotoMetadataModel.Empty };
