...
namespace FishingLogBook.Web.Tests.Features.Diagnostics.Services.DiagnosticLoggerTests;
...
public class WhenTestingLog
{
    ...
    public async Task ItShouldQueueAnOfflineDiagnosticEvent()
    {
        ...
        store.Items[0].SyncStatus.Should().Be(FishingLogBook.Web.Common.SyncStatus.SavedLocally);
    }
