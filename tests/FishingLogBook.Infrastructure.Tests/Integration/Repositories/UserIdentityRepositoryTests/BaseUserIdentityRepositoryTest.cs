...
namespace FishingLogBook.Infrastructure.Tests.Repositories.UserIdentityRepositoryTests;
...
public abstract class BaseUserIdentityRepositoryTest
{
    ...
    protected static FindUserIdentityArgs Lookup(string subject)
    {
        return new FindUserIdentityArgs
        {
