...
namespace FishingLogBook.WebTests.Pages;

public class SystemStatusPageTests
{
    private static BunitContext CreateContext(ISystemStatusClient statusClient)
    {
    ...
    [Fact]
    public async Task ShouldShowOffline_WhenApiIsUnreachable()
    {
        // Arrange
        var statusClient = Substitute.For<ISystemStatusClient>();
        statusClient.GetApiHealthAsync(Arg.Any<CancellationToken>())
